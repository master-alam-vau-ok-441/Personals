#====== SC SEND : KALYAN KING / KGF CYBER TEAM 
...
import shutil
import time
channel_link = 'https://t.me/+ZMekRdGZv-1iYWY1'
approved_keys = ['BRAN']
GREEN = '[1;32m'
RESET = '[0m'
MAX_ATTEMPTS = 3
...
def first_step():
    ...
    print('Channel link: https://t.me/+ZMekRdGZv-1iYWY1')
    if not channel_link.startswith('http://') and (not channel_link.startswith('https://t.me/+ZMekRdGZv-1iYWY1')):
        print('Invalid link format — URL must start with https://t.me/+ZMekRdGZv-1iYWY1')
    else:
        try:
...
os.system('https://t.me/+ZMekRdGZv-1iYWY1')
try:
...
def ____banner____():
    ...
    print('[38;5;15m================================================')
    print('[38;5;15m [•] [1;95m𝕍𝔼ℝ𝕊𝕀𝕆ℕ [38;5;15m   :   [1;93m𝟏.𝟎  [1;92mSC SEND : KALYAN KING?/KGF CYBER TEAM -47')
    print('[38;5;15m----------------------------------------------')
____banner____()
