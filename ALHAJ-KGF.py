...
sys.stdout.write('\x1b[1;35m\x1b]2; 彡KGF_CYBER_ᏦᏆΝᏀヅ \x07')
A0="\033[1;30m"
A1="\033[1;31m"
A2="\033[1;32m"
A3="\033[1;33m"
...
def Alhaj_uafb():
    ...
    return (As1)
os.system('espeak -a 50 " Walcame To, alhaj Send by kgf tem, open logo,  menu,but My Teligerm channel Jone you"')
...
{A1}╔═════════════════════════╦═════════════════════════╗
{A1}║ {A2}ᎪႮͲᎻϴᎡ • 彡ᎪᏞᎻᎪᎫ-ᏦᏆΝᏀヅ {A1}║ {A2}Teligerm : KGF CYBER TEAM / KALYAN KING    {A1}  ║
...
def Alhaj_404():
	...
	print(f"{A1}║{Tik} ҒᏴ-ᏟᎡᎪᏟᏦ ᎪᎠᎷᏆΝ ᏴᎽ ᎪᏞᎻᎪᎫ")
	print(f"{A1}╚══════════════════════════════════════╝");exit()
